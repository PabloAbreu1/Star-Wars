        ...
        actions: {
            ...
            buscarPersonajes: () => {
                fetch("https://www.swapi.tech/api/people/").then(res => res.json()).then(data => setStore({
                    personajesGuardados: data.results
            ...
            buscarPlanetas: () => {
                fetch("https://www.swapi.tech/api/planets/").then(res => res.json()).then(data => setStore({
                    planetasguardados: data.results
                })).catch(err => console.error(err))
            },
            ...
            buscarVehiculos: () => {
                fetch("https://www.swapi.tech/api/vehicles/").then(res => res.json()).then(data => setStore({
                    vehiculosguardados: data.results
                })).catch(err => console.error(err))
            },
            ...
            functCharacter: (id) => {
                fetch("https://www.swapi.tech/api/people/" + id).then(res => res.json()).then(data => setStore({
                    viewPersonajes: data.result
                })).catch(err => console.error(err))
            },


            functPlanetas: (id) => {
                fetch("https://www.swapi.tech/api/planets/" + id).then(res => res.json()).then(data => setStore({
                    viewPlanets: data.result
                })).catch(err => console.error(err))

            },

            functVehicle: (id) => {
                fetch("https://www.swapi.tech/api/vehicles/" + id).then(res => res.json()).then(data => setStore({
                    viewVehicles: data.result
                })).catch(err => console.error(err))
            },
